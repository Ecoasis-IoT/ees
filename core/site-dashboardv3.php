                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="ees-stat-card">
                            ...
                            <div>
                                ...
                                <div style="font-size:13px;margin-top:4px;">TX 1: <strong id="active_power1">—</strong></div>
                                <div style="font-size:13px;">TX 2: <strong id="active_power2">—</strong></div>
                                <div style="font-size:13px;">TX 3: <strong id="active_power3">—</strong></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12">
    ...
    $(function get_card_data(){
        ...
        $.ajax({
            ...
            success: function(dataResult) {
                ...
                // data.active_power2 = 0; //To be Removed
                
                document.getElementById('active_power1').innerHTML = parseFloat(data.active_power1).toFixed(2) + " kW";
                document.getElementById('active_power2').innerHTML = parseFloat(data.active_power2).toFixed(2) + " kW";
                document.getElementById('active_power3').innerHTML = parseFloat(data.active_power3).toFixed(2) + " kW";
    ...
    $.ajax({
        ...
        success: function(dataResult) {
            ...
            for(var i = 0; i < data.length; i++){
                ...
                else if(data[i].meter_id == "101"){
                    kpi_active_power2.push({"x": data[i].time, "y": data[i].active_power});    
                }
                else if(data[i].meter_id == "102"){
                    kpi_active_power3.push({"x": data[i].time, "y": data[i].active_power});    
                }
                
            }
            // console.log(kpi_active_power1);
            // console.log(kpi_active_power2);
            // console.log(kpi_active_power3);
        }
    });
}
...
function renderKpiChart(){
    ...
    const dataKPI = {
      ...
      {
        type: 'line',
        label: 'Main Meter 3 - Active Power (kW)',
        yAxisID: 'A',
        data: kpi_active_power3,
        fill: false,
        // backgroundColor: '#36648B',
        // borderColor: '#36648B',
        backgroundColor: '#162bff', //To change
        borderColor: '#162bff', // To change   
        tension: 0.4,
        pointRadius: 1,
        // pointHoverBackgroundColor: '#36648B',
        // pointBorderColor: 'transparent',
