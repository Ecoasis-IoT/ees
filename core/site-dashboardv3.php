    ...
    $(function get_card_data(){
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                document.getElementById('active_power3').innerHTML = n(data.active_power3).toFixed(2) + " kW";
            ...
            error: function(xhr, st, err) {
                console.warn('get_site_card_datav3 request error', st, err, xhr && xhr.status);
            }
        });
    });
