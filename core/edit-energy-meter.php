            ...
            <div class="block-header">
                <div class="row g-3">
                    <div class="col-lg-5 col-md-8 col-sm-12">                        
                        <h2><a class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Edit Energy Meter</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard"><i class="icon-home"></i></a></li>                            
                            <li class="breadcrumb-item">Energy Meter</li>
                            <li class="breadcrumb-item active">Edit Energy Meter</li>
                        </ul>
                    </div>            
                </div>
            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover editsitetbl">                       
                                    <tbody>                                                                       
                                        ...
                                        <tr>
                                            <td>Device Name</td>
                                            <td>
                                                <input style="width:30vw" type="text" class="editbox" name="username" id="userName" value="Energy Meter 1">
                                            </td>
                                            <tr>
                                                <td>Device Serial</td>
                                                <td>231241323123</td>
