    ...
    <tr>
      <td align="center" style="padding:30px 10px;">
        <table role="presentation" width="640" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff;border-radius:8px;overflow:hidden;">
          <tr>
            <td style="background:#70AD47;padding:28px 20px;text-align:center;">
              <p style="margin:0;font-size:24px;letter-spacing:1px;color:#ffffff;font-weight:bold;">SIGN-IN CODE</p>
              <p style="margin:8px 0 0 0;font-size:14px;color:#f0f9e8;">{$app_name}</p>
            </td>
          </tr>
          <tr>
            <td style="padding:32px 36px;color:#333333;font-size:15px;line-height:1.55;">
              ...
              <p style="margin:0 0 16px 0;text-align:center;font-size:32px;letter-spacing:8px;font-weight:bold;color:#70AD47;">{$code}</p>
              <p style="margin:0;color:#555555;">If you did not try to sign in, you can ignore this email.</p>
            </td>
          </tr>
          <tr>
            <td style="background:#f0f9e8;padding:18px 20px;text-align:center;">
              <p style="margin:0;font-size:12px;color:#5d9638;">Ecoasis Energy &mdash; {$app_name}</p>
            </td>
          </tr>
        </table>
      </td>
