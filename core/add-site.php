            ...
            <div class="block-header">
                <div class="row g-3">
                    <div class="col-lg-5 col-md-8 col-sm-12">                        
                        <h2><a class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Add Site</h2>
                        <ul class="breadcrumb">
                                ...
                                <table class="table table-striped table-bordered table-hover editsitetbl" id="myTable">                       
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input style="width:30vw" type="text" class="editbox" name="siteabbreviation" id="siteAbbreviation" value="">
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>Client</td>
                                            <td>
                                                <input style="width:30vw" type="text" class="editbox" name="client" id="clientId" value="">
                                            </td>
                                        </tr>                                        
                                    </tbody>
                                </table>
                                
                                <a class="btn btn-outline-dark" href="site">Discard</a>
