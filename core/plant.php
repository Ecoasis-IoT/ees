        ...
        $.ajax({
                ...
                success: function(dataResult) {
                    ...
                    for (var i = 0; i < data.length; i++){
                            ...
                            daily_prod.push(data[i]['prod']);
                            daily_ins.push(data[i]['insolation']);
                            daily_pr.push(data[i]['pr']);
        ...
        $.ajax({
            ...
            success: function(dataResult) {
                ...
                for (var i = 0; i < data.length; i++){
                    ...
                    h_year.push(data[i]['year']);
                    h_production.push(data[i]['production']);
                    h_insolation.push(data[i]['insolation']);
