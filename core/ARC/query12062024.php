                        ...
                        <div class="body p-0">
                            ...
                            <div class="tab-content no-pt">
                                <div class="tab-pane show active" id="Day">
                                    ...
                                    <div class="card g-3 mb-3 no-radius-top custom_hide_card">
                                                    ...
                                                    <div class="card text-center" style="height: 136px; overflow-y:auto">
                                                        ...
                                                        <div class="main-con" style="margin: 5px;border: none;">
                                                            ...
                                                            <!--<div class="input-container">-->
                                                                <h6>Meter Parameters</h6>
                                                                <input class="datacheckbox meter_param" name="meter_params" type="checkbox" value="prod">Production<br>
...
function get_custom(){
    ...
    if(document.getElementById('irradiance_param').checked == false){
        irr_param = 0;
    }
    else{
        irr_param = 1;
            ...
            success: function(dataResult) {
                ...
                if(irr_param == 1){
                    ...
                    for(let i = 0; i < data.length; i++){
                        ...
                        if(parseInt(data[i].meter_id) == 99){
