...
echo json_encode(array("active_power1"=>round($site_power[0]['active_power'],2),"active_power2"=>round($site_power[1]['active_power'],2), "daily_prod"=>round($site_daily['daily'],2), "monthly_prod"=>round($site_monthly['monthly'],2), "yearly_prod"=>round($site_yearly['yearly'],2), "avg_irr" => round($avg_irradiance['avg'], 2), "sun_hours" => $sun_hours['minutes']));
