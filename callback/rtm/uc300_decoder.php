...
if($dev_eui == "24e124468e236111"){
...
else if($dev_eui == "24e124468e237774"){
...
else if($dev_eui == "24e124468e283462"){
    ...
    $query2 = "INSERT INTO `plant_active_power`(`date`, `meter_id`, `meter_name`, `active_power`)  VALUES ('$timenow', $meter_id, '$meter_name', $active_power)";
