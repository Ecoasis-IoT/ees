...
$myfile1 = fopen("LOG_energy_test.txt", "a") or die("Unable to open file!");
    fwrite($myfile1, $timenow . ", " . $meter['id'] . ", " . $hex . ", " . $start_energy . ", " . $total_active_energy . ", " . $production . "\n");
fclose($myfile1);

try{
    $query = "INSERT INTO `tbl_main_meter`(`date`, `meter_id`, `meter_name`, `total_active_energy`) VALUES ('" . $round_date . "', '" . $meter["id"] . "','" . $meter["meter_name"] . "'," . round($total_active_energy, 5) . ")";
