    ...
    if($fPort == 5){
        ...
        if(substr($temp,0,2) == "03"){
                ...
                if($time >= $start and $time <= $end){
                    ...
                    $result = mysqli_query($phoenix_link, $get_data_id);
                    $arr_result = mysqli_fetch_assoc($result);
                    $data_id = $arr_result["id"];
                    
                    //Decoding Energy Meter Schneider IEM3250, Schneider PM300, Atersa MET Irradiance Sensor
