...
if ($time >= $start && $time <= $end) {
    ...
    $myfile1 = fopen(__DIR__ . "/BV_pvdb1_UC300_Energy_Downlink.txt", "a") or die("Unable to open file!");
    ...
    $myfile1 = fopen(__DIR__ . "/BV_pvdb2_UC300_Energy_Downlink.txt", "a") or die("Unable to open file!");
    fwrite($myfile1, date("Y-m-d H:i:s") . "\n");
    fclose($myfile1);
